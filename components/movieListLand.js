...
export default function MovieListLand({title, data, hideSeeAll}) {
        ...
        data.map((item, index) => {
            ...
            >
                <View className="mr-4 space-y-1">
                    ...
                    />
                    <Text className="text-neutral-300 ml-1 abs">{item.title.length > 30 ? item.title.slice(0,30) + "..." : item.title}</Text>
